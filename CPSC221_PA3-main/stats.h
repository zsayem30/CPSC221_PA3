...
public:
    ...
    /**
     * given two rectangles, return the weighted sum entropy of them.
     *
     * @param ulul is (x,y) of the upper left corner of the upper left rect
     * @param ullr is (x,y) of the lower right corner of the upper left rect
     * @param lrul is (x,y) of the upper left corner of the lower right rect
     * @param lrlr is (x,y) of the lower right corner of the lower right rect
     * the unweighted entropy is calculated by the entropy function,
     * and the weight is the area of the rectangle, calculated the rectArea
     * function
     */
    double weightedSumEntropy(pair<int, int> ulul, pair<int, int> ullr,
